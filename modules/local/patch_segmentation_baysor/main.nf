process PATCH_SEGMENTATION_BAYSOR {
    ...
    output:
    tuple val(meta), path(sdata_path), path("${sdata_path}/.sopa_cache/transcript_patches/${index}/segmentation_counts.loom"), path("${sdata_path}/.sopa_cache/transcript_patches/${index}/segmentation_polygons_2d.json"), val(n_patches)
