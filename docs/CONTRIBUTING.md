...
# `nf-core/sopa`: Contributing guidelines

Hi there!
Thanks for taking an interest in improving nf-core/sopa.

This page describes the recommended nf-core way to contribute to both nf-core/sopa and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of nf-core/sopa.

> [!NOTE]
> If you need help using or modifying nf-core/sopa, ask on the nf-core Slack [#sopa](https://nfcore.slack.com/channels/sopa) channel ([join our Slack here](https://nf-co.re/join/slack)).
...
- [ ] Check whether a GitHub [issue](https://github.com/nf-core/sopa/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [nf-core/sopa repository](https://github.com/nf-core/sopa) to your GitHub account.
...
For further information and help, see the [nf-core/sopa documentation](https://nf-co.re/sopa/usage) or ask on the nf-core [#sopa](https://nfcore.slack.com/channels/sopa) Slack channel ([join our Slack here](https://nf-co.re/join/slack)).

### GitHub Codespaces

You can contribute to nf-core/sopa without installing a local development environment on your machine by using [GitHub Codespaces](https://github.com/codespaces).
...
To get started, open the repository in [Codespaces](https://github.com/nf-core/sopa/codespaces).
...
nf-core semi-standardises how you write code and other contributions to make the nf-core/sopa code and processing logic more understandable for new contributors and to ensure quality.
